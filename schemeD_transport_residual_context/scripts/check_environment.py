...
def main() -> None:
    parser = argparse.ArgumentParser(description="Check Scheme D data and CUDA environment")
    ...
    report = {
        ...
        "autoencoder_checkpoint_bytes": ae_checkpoint.stat().st_size if ae_checkpoint.is_file() else 0,
