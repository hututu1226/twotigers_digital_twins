...
from scheme_d.angle_delay import ChannelShape
from scheme_d.autoencoder_training import build_autoencoder
from scheme_d.config import load_config
from scheme_d.context_model import FullResolutionContextField
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Inspect Scheme D latent and bottleneck sizes")
    ...
    context = FullResolutionContextField(
        ...
        spectrum_maximum_warp=tuple(section.get("spectrum_maximum_warp", [0.75, 1.5, 3.0])),
