...
from scheme_d.autoencoder_training import (
    evaluate_autoencoder,
    load_autoencoder_checkpoint,
)
from scheme_d.config import choose_device, load_config, save_json, worker_count
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate Scheme D on its fixed spatial fold")
