...
ARCHIVE="schemeA_results_${STAMP}.tar.gz"
...
required=(
  artifacts/preprocessed_1m/manifest.json
  artifacts/preprocessed_1m/metadata.npz
  artifacts/preprocessed_1m/static_cell_0.npz
  artifacts/preprocessed_1m/static_cell_1.npz
  ...
  artifacts/final/spatial/history.jsonl
...
optional=(
  ...
  artifacts/fold0/latent_diagnostics.json
  artifacts/fold0/spatial/best.pt
  artifacts/fold0/spatial/history.jsonl
  artifacts/fold0/spatial/summary.json
  artifacts/fold0/spatial/outage_scan.json
  artifacts/final/autoencoder/summary.json
  artifacts/final/spatial/summary.json
  logs/fold0.log
  logs/final.log
)
