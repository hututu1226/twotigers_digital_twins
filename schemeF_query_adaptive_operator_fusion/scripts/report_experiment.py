...
def main() -> None:
    parser = argparse.ArgumentParser(description="Write Scheme F experiment report")
    ...
    json_path = generated / f"schemeF_{args.stage}_experiment_report.json"
    md_path = generated / f"schemeF_{args.stage}_EXPERIMENT_REPORT.md"
    json_path.write_text(
        json.dumps(report, ensure_ascii=False, indent=2) + "\n", encoding="utf-8"
    )
    lines = [
        f"# Scheme F {args.stage.upper()} Experiment Report",
        "",
