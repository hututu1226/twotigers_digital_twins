...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Select the better of at most two Scheme F folds"
    )
    ...
    if not candidates:
        raise FileNotFoundError("No completed Scheme F attempt evaluation was found")
    ...
    report = {
        ...
        "recommended_for_submission": score >= 0.63,
        "warning": None
        if score >= 0.63
        else "Fold0 score is below 0.63; final output is diagnostic only.",
        "candidates": [
