...
mkdir -p logs artifacts/scheme_e_065/l1_005_metric_refiner ../research/scheme_e_065
...
python -u scripts/train_fullres_magnitude_refiner.py \
  ...
  --delay-crop 96 \
  --output-dir artifacts/scheme_e_065/l1_005_metric_refiner \
  --report ../research/scheme_e_065/L1_005_METRIC_REFINER.json \
  --device cuda
