...
from scheme_c.autoencoder_training import train_autoencoder
from scheme_c.config import load_config
from scheme_c.context_training import train_context_model
from scheme_c.encoding import encode_training_set
from scheme_c.inference import generate_test_channels
from scheme_c.preprocessing import preprocess_dataset


def main() -> None:
    parser = argparse.ArgumentParser(description="Run Scheme C end to end on a tiny sample")
    parser.add_argument(
