...
from scheme_g.autoencoder_training import (
    evaluate_autoencoder,
    load_autoencoder_checkpoint,
)
from scheme_g.config import choose_device, load_config, save_json, worker_count
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Evaluate Scheme G on its fixed spatial fold"
    )
