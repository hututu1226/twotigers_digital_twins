...
def main() -> None:
    ...
    old_architecture = str(
        old_section.get("architecture", "full_resolution_context_v1")
    )
    ...
    fields = (
        ...
        "router_width",
        "router_top_k",
        "router_candidate_top_k",
        "detail_router_top_k",
        "detail_router_candidate_top_k",
        "power_router_top_k",
        "power_router_candidate_top_k",
