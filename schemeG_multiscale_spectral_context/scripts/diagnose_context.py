...
from scheme_g.config import choose_device, load_config, seed_everything
from scheme_g.context_data import ContextRepository
from scheme_g.context_diagnostics import run_diagnostics
from scheme_g.context_training import load_context_checkpoint
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Diagnose which Scheme G Context component limits validation score"
    )
