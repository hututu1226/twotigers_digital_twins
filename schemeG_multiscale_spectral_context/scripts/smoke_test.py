...
from scheme_g.context_training import train_context_model
from scheme_g.encoding import encode_training_set
from scheme_g.inference import generate_test_channels
from scheme_g.preprocessing import preprocess_dataset


def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run Scheme G end to end on a tiny sample"
    )
    parser.add_argument(
    ...
    print("[4/5] multi-scale spectral Context with independent routers", flush=True)
