...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Translate D/E scans into bounded Scheme G edits"
    )
        ...
        decisions.append(
            {
                ...
                "action": "Scheme G temperature is persisted in state_dict",
            }
        )
            ...
            decisions.append(
                {
                    ...
                    "action": "tighten warp range; ordinary Detail channels are never phase-rotated",
                }
            )
