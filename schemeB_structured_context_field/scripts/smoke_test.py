...
from structured_context_field.autoencoder_training import train_autoencoder
...
from structured_context_field.preprocessing import preprocess_dataset


def main() -> None:
    parser = argparse.ArgumentParser(description="Run Scheme B end to end on a tiny sample")
    parser.add_argument(
